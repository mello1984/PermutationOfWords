...
public class Solution {
    ...
    public static void main(String[] args) throws WordArray.WordArrayException {
        ...
        testSequenceAlgorithm(testSequence2, 2);
        testSequenceAlgorithm(testSequence3, 3);
        testSequenceAlgorithm(new StringBuilder(testSequence1).reverse().toString(), 1);
        testSequenceAlgorithm(new StringBuilder(testSequence2).reverse().toString(), 2);
        testSequenceAlgorithm(new StringBuilder(testSequence3).reverse().toString(), 3);
